<?php 
    ...
    $article = [
      ...
      "organisation" => "news",
      "iconeAuteur" => "../images/icon-john.png",
      "datePublication" => "le 27mars 2018",
      "dateTime" => "2018-03-27", //cette variable va servir a ce que le site lise la date par rapport a la variable publication qui ne pourra le représenter, il sert pour le référencement
