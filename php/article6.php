<?php 
    ...
    $article = [
      ...
      "organisation" => "work",
      "iconeAuteur" => "../images/icon-tre.png",
      "datePublication" => "le 25 octobre 2018",
      "dateTime" => "2018-10-25", //cette variable va servir a ce que le site lise la date par rapport a la variable publication qui ne pourra le représenter, il sert pour le référencement
      "auteur" => "Trevor Bayne",
