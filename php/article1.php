<?php 
    ...
    $article = [
      ...
      "organisation" => "team",
      "iconeAuteur" => "../images/icon-dar.png",
      "datePublication" => "le 10 février 2018",
      "dateTime" => "2018-02-10", //cette variable va servir a ce que le site lise la date par rapport a la variable publication qui ne pourra le représenter, il sert pour le référencement
      "auteur" => "Daren Collison",
