<?php 
    ...
    $article = [
      ...
      "organisation" => "team",
      "iconeAuteur" => "../images/icon-tr.png",
      "datePublication" => "le 02 septembre 2018",
      "dateTime" => "2018-09-02", //cette variable va servir a ce que le site lise la date par rapport a la variable publication qui ne pourra le représenter, il sert pour le référencement
      "auteur" => "Terry Rozier",
