<?php 
    ...
    $article = [
      ...
      "organisation" => "work",
      "iconeAuteur" => "../images/icon-spr.png",
      "datePublication" => "le 31 juillet 2018",
      "dateTime" => "2018-07-31", //cette variable va servir a ce que le site lise la date par rapport a la variable publication qui ne pourra le représenter, il sert pour le référencement
      "auteur" => "Jack Sparrow",
